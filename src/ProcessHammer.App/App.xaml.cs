...
public partial class App : Application
{
    private static readonly string StartupLog = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "ProcessHammer", "startup.log");
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            MessageBox.Show(ex.ToString(), "Process Hammer — startup error", MessageBoxButton.OK, MessageBoxImage.Error);
            Shutdown(1);
        }
    }
    ...
    private void StartCore()
    {
        ...
        var dir = Path.Combine(
            Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "ProcessHammer");
    ...
    private void OnUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e)
    {
        ...
        {
            _errorShown = true;
            MessageBox.Show(e.Exception.Message, "Process Hammer — unexpected error",
