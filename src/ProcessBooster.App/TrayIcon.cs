...
/// <summary>
/// System-tray presence: keeps Process Booster running (so rules stay enforced) when the window is
...
public sealed class TrayIcon : IDisposable
{
    ...
    public TrayIcon(WpfWindow window, Action exit)
    {
        ...
        menu.Items.Add(new ToolStripMenuItem("Show Process Booster", null, (_, _) => ShowWindow()) { Font = new System.Drawing.Font(menu.Font, System.Drawing.FontStyle.Bold) });
    ...
    public void ShowRunningHint() =>
        _notify.ShowBalloonTip(3000, "Process Booster",
    ...
    private void ToggleStartup()
    {
        ...
        catch (Exception ex)
        {
            MessageBox.Show("Couldn't change the startup setting:\n" + ex.Message,
                "Process Booster", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Warning);
        }
    }
